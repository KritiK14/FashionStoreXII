...
def AddProduct():
    ...
    L.append(rate)
    product=(L)
    sql="Insert into product (product_id,PName,brand,Product_for,Season,\
rate)values(%s,%s,%s,%s,%s,%s)"
...
purchase.purchase_date,purchase.amount from product\
...
print("* * * * Developed by: Kriti Kakkar and Anshita Bala,\
Class XII-C, VBPS,Noida * * * * ")
print("*"*80)
print("")
MenuSet()
